...
<div class="item-form">
    ...
    <div class="form-group">
        <?php echo Html::submitButton($model->isNewRecord ? Yii::t('modules/page', 'Create') : Yii::t('modules/page', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
